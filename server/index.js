...
app.post('/api/carousel', async (req, res) => {
    const { title, description, image, sortOrder, isActive, carouselUrl, carouselButtonLabel } = req.body;
    const carousel = await prisma.carousel.create({ data: { title, description, image, sortOrder, isActive, carouselUrl, carouselButtonLabel } });
    res.json(carousel);
});
