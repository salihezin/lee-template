            ...
            <section className="section section-md bg-gray-light text-center">
                ...
                <div className="container">
                    ...
                    >
                            ...
                            <div className="owl-stage-outer">
                                ...
                                >
                                    <div
                                        ...
                                        style={{width: 690, marginRight: 30}}
                                    >
                                        <div className="item">
                                            {/* Quote Creative*/}
                                                ...
                                                <div className="quote-creative__main">
                                                    <div className="quote-creative__mark">
                                                        ...
                                                        >
                                                            <g fill="url(#grad1)">
                                                                <polyline
                                                                    points="8.955,21 0,14.031 0.002,0.001 15.984,0.001 15.984,13.984 8.969,14.016 "/>
                                                                <polyline
                                                                    points="31.97,20.999 23.016,14.031 23.018,0.001 39,0.001 39,13.984 31.984,14.015 "/>
                                                            </g>
                                                        </svg>
                                                    </div>
                                                    <div className="quote-creative__main-text">
                                                        <p>
                                                            TechSoft offers a high caliber of resources
                                                            skilled in Microsoft Azure .NET, mobile and
                                                            Quality Assurance. They became our true business
                                                            partners over the past three years of our
                                                            cooperation.
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="item">
                                            ...
                                            <article className="quote-creative">
                                                ...
                                                <div className="quote-creative__main">
                                                    ...
                                                    <div className="quote-creative__main-text">
                                                        <p>
                                                            TechSoft is a highly skilled and uniquely
                                                            capable firm with multitudes of talent on-board.
                                                            We have collaborated on a number of diverse
                                                            projects that have been a great success.
                                                        </p>
                                                    </div>
                                                </div>
                                            </article>
                        ...
                        <div className="owl-outer-navigation" id="owl-carousel-nav">
                            <button
                                type="button"
                                role="presentation"
                                className="owl-prev"
...
export default PageBodyOurClients;
