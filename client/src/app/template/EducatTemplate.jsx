...
const style = {
    ...
    nivoSliderImg: {display: 'none', width: "1287px"},
    nivoSliderImg2: {display: "inline", width: "1287px", height: "auto"},
    downLeftAnimation: {
        visibility: "visible",
    ...
    w180: {width: "180px"},
    translated: {opacity: 1, width: "2520px", transform: "translate3d(-540px, 0px, 0px)"},
    p0_10: {padding: "0px 10px"},
    l2935: {width: "587px", position: "relative", left: "-2935px", top: "0px", zIndex: 998, opacity: 0},
    l2348: {width: "587px", position: "relative", left: "-2348px", top: "0px", zIndex: 998, opacity: 0},
    l1761: {width: "587px", position: "relative", left: "-1761px", top: "0px", zIndex: 998, opacity: 0},
    l1174: {width: "587px", position: "relative", left: "-1174px", top: "0px", zIndex: 998, opacity: 0},
    l587: {width: "587px", position: "relative", left: "-587px", top: "0px", zIndex: 998, opacity: 0},
    l0: {width: "587px", position: "relative", left: "0px", top: "0px", zIndex: 999, opacity: 1},
    o1: {opacity: 1, width: "3522px"},
}

const EducatTemplate = () => {
    useEffect(() => {
                                    ...
                                    <div className="col-lg-5 col-md-7 col-12">
                                        <div className="header-top-right">
                                            <div className="content"><a href="#"><i
                                                className="zmdi zmdi-account"></i> My
                                                Account</a>
                                                <ul className="account-dropdown">
                                                    <li><a href="/educat-preview/educat/login-register">My Account</a>
                                                    </li>
                                                    <li><a href="/educat-preview/educat/login-register">Log In</a></li>
                                                    <li><a href="/educat-preview/educat/login-register">Register</a>
                                                    </li>
                                    ...
                                    <div className="col-lg-3 col-12">
                                        <div className="logo">
                                            <a href="/educat-preview/educat/">
                                                <img src="educat/styles/img/logo/logo.png"
                                                     alt="EDUCAT"/></a>
                                        </div>
                                    </div>
                                                ...
                                                <nav>
                                                    <ul id="nav">
                                                        <li className="current"><a
                                                            href="/educat-preview/educat/">Home</a>
                                                            <ul className="sub-menu">
                                                                <li><a href="/educat-preview/educat/">Slider Style 1</a>
                                                                </li>
                                                                <li><a href="/educat-preview/educat/index-2">Slider
                                                                    Style 2</a></li>
                                                                <li><a href="/educat-preview/educat/index-3">Background
                                                                    Image</a></li>
                                                                <li><a href="/educat-preview/educat/index-4">Image
                                                                    Overlay Light</a></li>
                                                                <li><a href="/educat-preview/educat/index-5">Image
                                                                    Overlay Dark</a></li>
                                                                ...
                                                                <li><a href="/educat-preview/educat/index-10">Fixed
                                                                    Image</a></li>
                                                                <li><a href="/educat-preview/educat/index-11">Overlay
                                                                    Fixed Image</a></li>
                                                            </ul>
                                                        </li>
                                                            ...
                                                            <ul className="sub-menu">
                                                                <li><a href="#">Sliders<i
                                                                    ...
                                                                    <ul className="inside-menu">
                                                                        <li><a
                                                                            href="/educat-preview/educat/slider-style-1">Slider
                                                                            Style 1</a></li>
                                                                        <li><a
                                                                            href="/educat-preview/educat/slider-style-2">Slider
                                                                            Style 2</a></li>
                                                                        <li><a
                                                                            href="/educat-preview/educat/slider-style-3">Slider
                                                                            Style 3</a></li>
                                                                        <li><a
                                                                        ...
                                                                        <li><a
                                                                            ...
                                                                            Background </a></li>
                                                                        <li><a
                                                                            href="/educat-preview/educat/fixed-image">Fixed
                                                                            Image</a></li>
                                                                        <li><a
                                                                ...
                                                                <li><a href="#">Menu Style<i
                                                                    ...
                                                                    <ul className="inside-menu">
                                                                        <li><a
                                                                            href="/educat-preview/educat/theme-menu-1">Theme
                                                                            Menu 1</a></li>
                                                                        <li><a
                                                                            href="/educat-preview/educat/theme-menu-2">Theme
                                                                            Menu 2</a></li>
                                                                        <li><a
                                                                            href="/educat-preview/educat/theme-menu-3">Theme
                                                                            Menu 3</a></li>
                                                                        <li><a
                                                                            href="/educat-preview/educat/without-top-bar">Without
                                                                            Top Bar</a></li>
                                                                        <li><a
                                                                            href="/educat-preview/educat/menu-center">Menu
                                                                            Center</a></li>
                                                                        <li><a
                                                                        ...
                                                                        <li><a href="/educat-preview/educat/menu-dark">Menu
                                                                            Dark</a></li>
                                                                        <li><a
                                                                            href="/educat-preview/educat/borderd-menu">Menu
                                                                            Border</a></li>
                                                                        <li><a
                                                                            href="/educat-preview/educat/menu-top-border">Top
                                                                            Border Hover</a></li>
                                                                        <li><a
                                                                            href="/educat-preview/educat/menu-sticky">Menu
                                                                            Sticky</a></li>
                                                                        <li><a
                                                                ...
                                                                <li><a href="#">Footer Style<i
                                                                    ...
                                                                    <ul className="inside-menu">
                                                                        <li><a
                                                                            href="/educat-preview/educat/footer-style-1">Footer
                                                                            Style 1</a></li>
                                                                        <li><a
                                                                            href="/educat-preview/educat/footer-style-2">Footer
                                                                            Style 2</a></li>
                                                                        <li><a
                                                                            href="/educat-preview/educat/footer-style-3">Footer
                                                                            Style 3</a></li>
                                                                        <li><a href="footer-style-4.html">Footer Style
                                                                            4</a></li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="/educat-preview/educat/">Shortcode</a>
                                                        <ul className="sub-menu">
                                                            ...
                                                            <li><a
                                                                href="/educat-preview/educat/shortcode-event">Event</a>
                                                            </li>
                                                            ...
                                                            <li><a href="/educat-preview/educat/shortcode-contact-form">Contact
                                                                Form</a></li>
                                                            <li><a href="/educat-preview/educat/shortcode-map">Map</a>
                                                            </li>
                                                            <li><a
                                                                href="/educat-preview/educat/shortcode-facts">Facts</a>
                                                            </li>
                                                            ...
                                                            <li><a href="/educat-preview/educat/video-gallery">Video
                                                                Gallery</a></li>
                                                            <li><a
                                                                href="/educat-preview/educat/shortcode-alerts">Alerts</a>
                                                            </li>
                                                            <li><a
                                                                href="/educat-preview/educat/shortcode-button">Button</a>
                                                            </li>
                                                            <li><a
                    ...
                    <div className="slider-area">
                        <div className="preview-2">
                                                ...
                                                <div className="col-md-12">
                                                    <div className="text-content-wrapper">
                                                        <div className="text-content">
                                                            ...
                                                            <div className="banner-readmore wow fadeInUp"
                                                                 data-wow-duration="3600ms" data-wow-delay=".6s"
                                                                 style={style.fadeInUpAnimation2}
                                                            >
                            ...
                            <div className="nivo-controlNav"><a className="nivo-control active" rel="0">1</a><a
                                className="nivo-control" rel="1">2</a></div>
                                    ...
                                    <div className="single-item">
                                        ...
                                        <div className="single-item-text">
                                            ...
                                            <p>There are many variations of sages of Lorem Ipsum available, but the
                                                ...
                                                are many but the mri have suffered alteration in some </p>
                                        ...
                                        <div aria-live="polite" className="slick-list">
                                            <div className="slick-track"
                                                ...
                                                <div className="sin-testiText slick-slide" data-slick-index="1"
                                                    ...
                                                    <p>Nam nec tellus a odio tincidunt This lorem is Photoshop's version
                                                        of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet.
                                                        Aenean nisi sollicitudin, lorem quis bibendum auctor, nisi elit
                                                        consequat ipsum gravida.</p>
                                                </div>
                                                <div className="sin-testiText slick-slide" data-slick-index="2"
                                                    ...
                                                    <h2>Kattie Luis</h2>
                                                    <p>Nam nec tellus a odio tincidunt This is Photoshop's version of
                                                        Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean
                                                        tincidunt sollicitudin, lorem quis bibendum auctor, nisi elit
                                                        consequat ipsum Photoshop.</p>
                                                </div>
                                                ...
                                                <div className="sin-testiText slick-slide" data-slick-index="4"
                                                    ...
                                                    <p>Nam nec tellus a odio tincidunt This is Photoshop's version of
                                                        Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean
                                                        sollicitudin, aliquet lorem quis tellus velit bibendum auctor,
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="single-event-item">
                                        ...
                                        <div className="single-event-text">
                                            ...
                                            <p>There are many variaons of passa of Lorem Ipsuable, amrn in sofby
                                                injected humour, amr sarata din megla....</p>
                                            <a className="button-default" href="#">LEARN Now</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-3 col-md-6">
                                    <div className="single-footer-widget">
                                        <div className="footer-logo">
                                            <a href="/educat-preview/educat/"><img
                                                src="educat/styles/img/logo/footer.png"
                                                alt=""/></a>
                                        </div>
                                        <p>There are many variations of passg of Lorem Ipsum available, but thmajority
                                            have suffered altem, </p>
                                ...
                                <div className="col-lg-3 col-md-6">
                                    <div className="single-footer-widget">
                                        <h3>GET IN TOUCH</h3>
                                        <a href="tel:0123-456-789"><i className="fa fa-phone"></i>0123-456-789</a>
